...
`define QPU_EVENT_NUM (`QPU_QI_XYEVENT_NUM + `QPU_MEASURE_EVENT_NUM + `QPU_QI_ZEVENT_NUM)         //1 QI xyevent of each qubit ,1 zevent , 1 measure event for AGU and 1 measure event for MCU
